...
const StaffAccountCard = ({ account }) => {
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-xl p-6 shadow-sm">
      ...
      <div className="grid grid-cols-2 gap-y-4 text-xs">
        ...
        <div>
          ...
          <p className="font-semibold text-slate-800 mt-1">{account.username}</p>
        </div>
        <div>
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
            USER ID
        ...
        <div>
          ...
          <p className="font-semibold text-slate-800 mt-1">{account.systemRole}</p>
        </div>
        <div>
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
            LAST LOGIN
          </p>
          <p className="font-semibold text-slate-800 mt-1">{account.lastLogin}</p>
        </div>
        <div>
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
            PROFILE CREATED
