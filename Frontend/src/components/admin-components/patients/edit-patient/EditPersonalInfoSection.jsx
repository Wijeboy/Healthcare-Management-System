  ...
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-xl p-6 shadow-sm mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Review and update the patient's identity and demographic information.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="border border-dashed border-[#CBD5E1] bg-[#F8FAFC] rounded-xl p-4 flex items-center gap-4 mb-6">
        ...
        <div>
          <h4 className="text-xs font-bold text-slate-800">Patient Profile Photo</h4>
          ...
          <div className="flex items-center gap-3 mt-2.5">
            ...
            <button type="button" className="text-xs font-semibold text-rose-600 hover:underline cursor-pointer">
              Remove
            </button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
        ...
        <div>
          ...
          <span className="text-[10px] text-slate-400 mt-1 block">
            Age is calculated automatically from the date of birth.
          </span>
        </div>
