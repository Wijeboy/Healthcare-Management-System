...
const notifications = [
  {
    ...
    message: 'Critical patient admitted to ICU - Bed 12A',
    time: '2 min ago',
    type: 'critical',
    read: false,
  },
  {
    ...
    message: 'Dr. Sarah Lin confirmed appointment with patient #8823',
    time: '15 min ago',
    type: 'info',
    read: false,
  },
  {
    ...
    message: 'Blood work results for Marcus Thorne are available',
    time: '1 hour ago',
    type: 'success',
    read: false,
  },
  ...
  },
  {
    ...
    message: 'Elena Rodriguez registered via online portal',
    time: '3 hours ago',
    type: 'info',
    read: true,
  },
