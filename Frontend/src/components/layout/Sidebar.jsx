...
const navItems = [
  ...
  { icon: 'calendar_today', label: 'Appointments', path: '/dashboard/appointments' },
  { icon: 'folder_shared', label: 'Records', path: '/dashboard/records' },
  { icon: 'medical_services', label: 'Prescriptions', path: '/dashboard/prescriptions' },
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen flex flex-col py-6 px-4 w-64 z-40 bg-surface-container-low border-r border-outline-variant">
      ...
      <div className="mb-8 px-2">
        ...
        <p className="text-xs font-semibold tracking-widest uppercase text-on-surface-variant">Admin Portal</p>
      </div>
