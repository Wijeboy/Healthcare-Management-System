...
const ROLES = [
  {
    ...
    label: 'Patient',
    icon: (active) => (
      <svg xmlns="http://www.w3.org/2000/svg" className={`w-5 h-5 ${active ? 'text-[#1D4ED8]' : 'text-slate-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      ...
      <section className="hidden lg:flex lg:w-1/2 relative bg-primary-container items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-10 max-w-xl text-white">
          ...
          <p className="text-base opacity-85 leading-6">
            Seamlessly manage patient records, appointments, and prescriptions with our integrated clinical dashboard.
          </p>
        </div>
      </section>
      ...
      <section className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-10 bg-white relative">
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col items-center mb-7">
            <p className="text-[#1D4ED8] font-bold text-base tracking-wide">Medimate Healthcare</p>
          </div>

          {/* Form Header */}
          <div className="mb-6">
            <h1 className="text-[30px] font-bold text-slate-900 leading-tight tracking-tight">Welcome Back</h1>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-3 gap-3">
                {ROLES.map((role) => {
                  ...
                  return (
                    ...
                    >
                      {role.icon(isActive)}
                      <span className={`text-xs font-semibold ${isActive ? 'text-[#1D4ED8]' : 'text-slate-600'}`}>
                        {role.label}
                      </span>
                    </button>
                  )
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <Link className="text-sm text-[#1D4ED8] font-semibold hover:underline" to="/forgot-password">
                  Forgot Password?
                </Link>
              </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-slate-500">
              ...
              <Link className="text-[#1D4ED8] font-semibold hover:underline" to="/register">
                Register here
              </Link>
            </p>
          </div>
